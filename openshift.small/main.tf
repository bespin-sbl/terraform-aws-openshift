...
output "master-node3_dns" {
  value = "${module.openshift.node3-public_dns}"
}

output "master-node3_ip" {
  value = "${module.openshift.node3-public_ip}"
}

output "master-etcd1_dns" {
  value = "${module.openshift.etcd1-public_dns}"
}

output "master-etcd1_ip" {
  value = "${module.openshift.etcd1-public_ip}"
}

output "master-etcd2_dns" {
  value = "${module.openshift.etcd2-public_dns}"
}

output "master-etcd2_ip" {
  value = "${module.openshift.etcd2-public_ip}"
}

output "master-etcd3_dns" {
  value = "${module.openshift.etcd3-public_dns}"
}

output "master-etcd3_ip" {
  value = "${module.openshift.etcd3-public_ip}"
}
